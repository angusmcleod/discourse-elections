...
describe ::DiscourseElections::NominationController do
  ...
  describe "set_by_username" do
    include_examples 'requires election admin', :put, :set_by_username, topic_id: 5, usernames: ["angus"]
    ...
    context "while logged in as an admin" do
      ...
      it "works with a single username in a string" do
        ...
        xhr :put, :set_by_username, topic_id: topic.id, usernames: usernames
      ...
      it "works with an empty string" do
        ...
        xhr :put, :set_by_username, topic_id: topic.id, usernames: ""
        expect(response).to be_success
        json = ::JSON.parse(response.body)
      ...
      it "requires each username to be a real username" do
        ...
        expect { xhr :put, :set_by_username, topic_id: topic.id, usernames: usernames }
      ...
      it "requires more than 2 usernames if status is poll" do
        ...
        expect { xhr :put, :set_by_username, topic_id: topic.id, usernames: user1.username }
